CREATE TABLE IF NOT EXISTS max_country (
...
CREATE TABLE IF NOT EXISTS max_city (
     id             int,
...
CREATE TABLE IF NOT EXISTS max_city_name (
    city_id         int,
    language        CHARACTER VARYING(3)    NOT NULL,
    city_name	    CHARACTER VARYING(50)   NOT NULL,
    CONSTRAINT max_city_name_pk PRIMARY KEY (city_id, language)
);
ALTER TABLE max_city_name ADD CONSTRAINT max_city_name_fk_01 FOREIGN KEY (city_id) REFERENCES max_city (id);
...
CREATE TABLE IF NOT EXISTS max_city2 (
   id int,
...
CREATE TABLE IF NOT EXISTS net_country_name (
    id int NOT NULL,
    language CHARACTER VARYING(3) NOT NULL,
...
ALTER TABLE net_country_name ADD CONSTRAINT net_country_name_fk_01 FOREIGN KEY (id)  REFERENCES net_country (id);
...
CREATE TABLE IF NOT EXISTS net_city_name (
    id int,
    language     CHARACTER VARYING(3)    NOT NULL,
    name         CHARACTER VARYING(100)  NOT NULL,
    region       CHARACTER VARYING(10),
...
ALTER TABLE net_city_name ADD CONSTRAINT net_city_name_fk_01 FOREIGN KEY (id)  REFERENCES net_city (id);
...
INSERT INTO marital_status (marital_status_id, language, gender, status_name) VALUES (4, 'ru', 'm', 'живем отдельно, в процессе развода');
...
INSERT INTO marital_status (marital_status_id, language, gender, status_name) VALUES (4, 'ru', 'w', 'живем отдельно, в процессе развода');
...
INSERT INTO ad (language, gender, date_of_birth, ad_nickname, marital_status_id) VALUES ('ru', 'm', '1971-01-11', 'Вася', '2');
INSERT INTO ad (language, gender, date_of_birth, ad_nickname, marital_status_id) VALUES ('ru', 'w', '1972-02-12', 'Васелиса', '3');
INSERT INTO ad (language, gender, date_of_birth, ad_nickname, marital_status_id) VALUES ('en', 'm', '1973-03-13', 'Jhon', '4');
INSERT INTO ad (language, gender, date_of_birth, ad_nickname, marital_status_id) VALUES ('en', 'w', '1974-04-14', 'Vanessa', '5');
...
BEGIN
    ...
    IF NEW.city_id <> OLD.city_id THEN
        SELECT longitude INTO NEW.longitude FROM max_city WHERE id = NEW.city_id;
        SELECT latitude  INTO NEW.latitude  FROM max_city WHERE id = NEW.city_id;
    END IF;
